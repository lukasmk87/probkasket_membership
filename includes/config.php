// includes/config.php - Datenbankverbindung
<?php
// Datenbankverbindung
$db_host = 'localhost';
$db_user = 'your_db_user';  // Ändern Sie dies zu Ihrem all-inkl.com Datenbankbenutzer
$db_pass = 'your_db_password';  // Ihr Datenbankpasswort
$db_name = 'your_db_name';  // Ihr Datenbankname
