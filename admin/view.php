    ...
    <div class="container admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="admin-actions" style="margin-top: 30px;">
                ...
                <a href="delete.php?id=<?php echo $registration['id']; ?>" class="btn-delete" onclick="return confirm('Sind Sie sicher, dass Sie diese Anmeldung löschen möchten?');">Löschen</a>
